 ...
 * 
 */
@WebServiceClient(name = "PlatformOldWebService", targetNamespace = "http://ws.platform.ztw.com", wsdlLocation = "http://183.224.79.167/sws?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://183.224.79.167/sws?wsdl");
